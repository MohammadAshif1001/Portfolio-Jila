...
<section class="bg-slate-950 container mx-auto p-4 text-center rounded-b-2xl">
        <div class="mx-auto">
        
            <button id="downloadButton" class="bg-slate-900 hover:bg-slate-800 active:bg-slate-700 focus:outline-none focus:ring focus:ring-violet-300 rounded-md px-3 py-2 text-cyan-500 font-serif  hover:text-cyan-400 shadow-md mt-5 cursor-pointer">
                <div class="flex items-center justify-center">
                    <!-- Download Icon -->
