...
<head>
    ...
    <title>Mohammad Ashif's Creative Portfolio | Portfolio Jila</title>
</head>
<body class="bg-blue-500">
<div id="particles" class="absolute w-full h-full top-0 left-0" style="position: absolute;
    width: 100%;
    height: 100%;
    top: 0;
    left: 0;"></div>
    <nav>
        <div class="nav-logo">
            <a href="#">
                <img src="include/img/logoNJ.png">
            </a>
        </div>
