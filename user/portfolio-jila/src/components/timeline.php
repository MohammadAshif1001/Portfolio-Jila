<section>
  <div class="timeline flex flex-wrap flex-row justify-between mt-20">
    <div class="flex items-center justify-center bg-slate-950 px-6 md:px-60">
      <div class="space-y-6 border-l-2 border-slate-900 border-dashed">
